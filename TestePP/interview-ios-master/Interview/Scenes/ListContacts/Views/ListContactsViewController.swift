...
class ListContactsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        configureViews()
        UserDefaults.standard.setValue(UserDefaults.standard.bool(forKey: CacheKeys.FIRST_ACESS.rawValue), forKey: CacheKeys.OFFLINE_CONTACT.rawValue)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contactImage.image = contacts[indexPath.row].img
